...
compile()
{
  xmvlog -work xpm "../../../microprocessor.srcs/sources_1/new/top.v" $xmvlog_opts -sv \
  ...
  xmvlog -work xil_defaultlib "../../../microprocessor.srcs/sources_1/new/top.v" $xmvlog_opts \
  "../../../microprocessor.srcs/sources_1/new/top.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_8 "../../../microprocessor.srcs/sources_1/new/top.v" $xmvlog_opts \
