...
#
# Script generated by Vivado on Sat Nov 30 07:09:24 +0530 2024
...
# script info
echo -e "tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm "../../../microprocessor.srcs/sources_1/new/top.v" $vlogan_opts -sverilog \
  ...
  vlogan -work xil_defaultlib "../../../microprocessor.srcs/sources_1/new/top.v" $vlogan_opts +v2k \
  "../../../../../../../Aditya/ Sharma/Documents/Verilog/microprocessor/microprocessor.srcs/sources_1/new/top.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work blk_mem_gen_v8_4_8 "../../../microprocessor.srcs/sources_1/new/top.v" $vlogan_opts +v2k \
  ...
  "../../../../../../../Aditya/ Sharma/Documents/Verilog/microprocessor/microprocessor.srcs/sim_1/new/tb_top.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
